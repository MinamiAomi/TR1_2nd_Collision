...
std::size_t Renderer::CreatePlaneMesh() {
    std::vector<Vertex> vertices = {
...
std::size_t Renderer::CreateBoxMesh() {
...
std::size_t Renderer::CreateSphereMesh() {
    // 球を作成
    std::vector<Vertex> vertices;
    std::vector<uint16_t> indices;
    {
...
std::size_t Renderer::CreateCylinderMesh() {
    std::vector<Vertex> vertices;
    std::vector<uint16_t> indices;
